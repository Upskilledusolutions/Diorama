    ...
    <div>
      <div className={styles.banner}>
        ...
        <div className={styles.content}>
          <div className={styles.heading3}>Recent Creative Non-Fiction</div>
...
<div className={styles.featslider}>
    <NewSlider titlehead={'Prose'} title={'Featured Creative Non-Fiction'} slider={3}/>
    </div>
    <div className={styles.emerslider}>
